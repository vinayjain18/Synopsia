...
def disease_pred(request):
    ...
    model = joblib.load('C:\\Users\\Vinay\\OneDrive\\Documents\\git clone\\ai-doctor\\core\\random_forest.pkl')
    if request.method == "POST":
...
def drug_pred(request):
    model = joblib.load('C:\\Users\\Vinay\\OneDrive\\Documents\\git clone\\ai-doctor\\core\\medical_nb.pkl')
